...
class HomeRecentWatchContainerCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.collectionView.register(UINib(nibName: HomeRecentWatchItemCell.identifier, bundle: .main), forCellWithReuseIdentifier: HomeRecentWatchItemCell.identifier)
